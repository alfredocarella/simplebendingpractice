...
def test_get_reaction_forces():
    ...
    F_Ax, F_Ay, F_By = beam.get_reaction_forces(x_coords, (FRx, FRy), M_R)
    expected = 20, 109, 41
...
def test_calculate_diagrams():
    ...
    fixed_support = 2
    rolling_support = 7
    loads = [beam.PointLoad(-20, 3),
             beam.DistributedLoad(-20, (0, 2)),
             beam.DistributedLoad("-10", (3, 9))]

    x0, x1, dist_forces, shear_forces, bending_moments = beam.calculate_diagrams(beam_span, fixed_support,
