...
from bendinx import Beam
from bendinx import DistributedLoad
from bendinx import PointLoad
from bendinx import PointTorque
from bendinx import plot_numerical


class TestBeam(unittest.TestCase):
    def setUp(self):
        self.my_beam = Beam(10, (0, 9), plot_resolution=500)
